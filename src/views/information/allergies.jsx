...
export default function AllergiesInfoScreen({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={[custom_styles.h3, {color: colors.text}]}>
          Allergy information
        </Text>
        <View />
      </View>
      <ScrollView style={styles.body}>
        {currentTab == 1 && (
          <View style={{marginTop: 20}}>
            ...
            <TouchableOpacity
              onPress={() => setQuestionOne(1)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionOne == 1 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
              ...
              <Text
                style={[custom_styles.h3, {color: colors.text, marginLeft: 5}]}>
                Yes, I have
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => setQuestionOne(2)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionOne == 2 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
            ...
            <TouchableOpacity
              onPress={() => setQuestionOne(3)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionOne == 3 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
        ...
        {currentTab == 2 && (
          <View style={{marginTop: 20}}>
            ...
            <TouchableOpacity
              onPress={() => setQuestionTwo(1)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionTwo == 1 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
            ...
            <TouchableOpacity
              onPress={() => setQuestionTwo(2)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionTwo == 2 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
            ...
            <TouchableOpacity
              onPress={() => setQuestionTwo(3)}
              style={[styles.list]}>
              <View
                style={[
                  [
                    styles.big_circle,
                    questionTwo == 3 && {borderColor: primary_color},
                  ],
                ]}>
                <View
                  style={[
        ...
        <TouchableOpacity
          ...
          <Text style={[custom_styles.button_text, {marginRight: 5}]}>
            Save
          </Text>
          <SvgXml
            width={20}
