import { View, Text, Modal, Animated, StyleSheet, Dimensions, Pressable, TouchableOpacity, TouchableWithoutFeedback, Easing } from 'react-native'
...
const FracModal = (props, ref) => {
    ...
    if (type === "center") {
        return (
            <Modal
                ...
                <Pressable onPress={() => maxHeight !== height ? closeModal() : {}} style={[styles.centeredView, { justifyContent: 'center', alignItems: 'center' }]} >
    ...
    return (
        <Modal
            ...
            onRequestClose={() => closeModal()}
            visible={modalVisible}>
            <Pressable onPress={() => maxHeight !== height ? closeModal() : {}} style={styles.centeredView} >
                <TouchableWithoutFeedback>
